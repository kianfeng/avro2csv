...
public class Twitter extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.avro.example.Twitter.Builder newBuilder() {
    return new com.avro.example.Twitter.Builder();
  }
   ...
   * @return A new Twitter RecordBuilder
   */
  public static com.avro.example.Twitter.Builder newBuilder(com.avro.example.Twitter.Builder other) {
    if (other == null) {
      return new com.avro.example.Twitter.Builder();
    } else {
      return new com.avro.example.Twitter.Builder(other);
    }
  }
   ...
   * @return A new Twitter RecordBuilder
   */
  public static com.avro.example.Twitter.Builder newBuilder(com.avro.example.Twitter other) {
    if (other == null) {
      return new com.avro.example.Twitter.Builder();
    } else {
      return new com.avro.example.Twitter.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Twitter>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.avro.example.Twitter.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.avro.example.Twitter other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.username)) {
        this.username = data().deepCopy(fields()[0].schema(), other.username);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.example.Twitter.Builder setUsername(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.example.Twitter.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.example.Twitter.Builder setTweet(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.example.Twitter.Builder clearTweet() {
      tweet = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.example.Twitter.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.example.Twitter.Builder clearTimestamp() {
